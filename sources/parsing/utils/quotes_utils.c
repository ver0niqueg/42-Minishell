...
/*Permet de supprimer deux caracteres specifiques, un a la position de i, l'autre
a la position de end. On supprime et on decale tous les autres char vers la gauche */
char    *erased_str(char *str, int i, int end)
{
    ...
    // Suppression du caractère à la position i
